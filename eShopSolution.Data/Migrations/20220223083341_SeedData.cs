    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                table: "Orders",
                nullable: false,
                defaultValue: new DateTime(2022, 2, 23, 15, 33, 41, 48, DateTimeKind.Local).AddTicks(5662),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2022, 2, 23, 14, 29, 14, 62, DateTimeKind.Local).AddTicks(5671));
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 2, 23, 15, 33, 41, 68, DateTimeKind.Local).AddTicks(1099), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 2, "vi-VN", "Áo nữ", "ao-nu", "Sản phẩm áo thời trang nam", "Sản phẩm áo thời trang nữ" },
                    { 2, 1, "en-US", "Men Shirt", "men-shirt", "The shirt products for men", "The shirt products for men" },
                    { 4, 2, "en-US", "Women Shirt", "women-shirt", "The shirt products for men", "The shirt products for women" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2022, 2, 23, 14, 29, 14, 62, DateTimeKind.Local).AddTicks(5671),
                oldClrType: typeof(DateTime),
                oldDefaultValue: new DateTime(2022, 2, 23, 15, 33, 41, 48, DateTimeKind.Local).AddTicks(5662));
        }
    }
}
