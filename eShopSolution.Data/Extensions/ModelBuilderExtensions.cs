    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CategoryTranslation>().HasData(
                    ...
                    new CategoryTranslation() { Id = 3, CategoryId = 2, Name = "Áo nữ", LanguageId = "vi-VN", SeoAlias = "ao-nu", SeoDescription = "Sản phẩm áo thời trang nam", SeoTitle = "Sản phẩm áo thời trang nữ" },
            ...
            // any guid
            var roleId = new Guid("8672B2FF-FA80-46E3-BD2C-9C55E6AD035B");
            var adminId = new Guid("45241BA9-A243-46E1-8591-FBE58D4D75B8");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "thangduybt2000@gmail.com",
                NormalizedEmail = "thangduybt2000@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "123456"),
                SecurityStamp = string.Empty,
                FirstName = "Thang",
                LastName = "Duy",
                Dob = new DateTime(2000, 01, 13)
            });
